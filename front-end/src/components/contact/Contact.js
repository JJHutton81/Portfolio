    ...
    const pages = [
      style => (
        <animated.div style={{ ...style }} className='ContactWrap'>
          <h1 className='ContactTitle'>This site is under almost constant construction. Check back often for more clever little transitions, animations, and projects. </h1>
          <h1 className='ContactTitle'>Do you have any questions, comments, or want to work with me?</h1>
          <span className='PsudoButt' onClick={this.toggleContact}>Contact Me</span>
          <h1 className='ContactTitle'>Let's make something special.</h1>
        </animated.div>
      ),
      style => (
        <animated.div style={{ ...style }} className='ContactWrap'>
          <form className='form-body' method="POST" action="https://formspree.io/jjhutton81@gmail.com">
            <input type="email" name="email" placeholder="Enter Your Email" className="form-input" />
            <textarea name="message" contenteditable="true" placeholder="What's on your mind?" wrap="soft" className="form-text"></textarea>
            <button type="submit" className="Btn">Submit</button>
            <span className='PsudoButt' onClick={this.toggleBackContact}>Close</span>
          </form>
        </animated.div>
      )
    ]
